<%-- 
    ...
    Created on : 26-Jul-2022, 4:29:30 pm
    Author     : SURAJ BORA
--%>
...
<html lang="en">
    <head>
        ...
        <title>Contact Page-blogger den</title>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="index.jsp"><i class="fa-brands fa-elementor"></i>Blogger Den</a>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('image/contact-bg.jpg')">
